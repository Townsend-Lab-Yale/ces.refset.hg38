...
# Figure out name by inspecting output of getFromNamespace(".NCBI_cached_chrom_info", "GenomeInfoDb") and choosing latest version
ncbi_info = getFromNamespace(".NCBI_cached_chrom_info", "GenomeInfoDb")[["GCF_000001405.40"]]
